...
Vale ressaltar que é importante não confundir a segurança cibernética com a segurança da informação, pois ambas são diferentes, embora relacionadas. Como mencionado, a cibersegurança lida diretamente com a proteção de sistemas e redes de computadores contra ameaças cibernéticas. Já a segurança da informação abrange toda a proteção de dados e informações — seu foco está em garantir que as informações estejam acessíveis apenas a pessoas autorizadas. Portanto, as duas são diferentes, porém interligadas: a cibersegurança é uma ramificação da segurança da informação.

Dentro da cibersegurança, há divisões de práticas tomadas para garantir essa segurança, divididas em grupos. Os principais serão apresentados a seguir.
...
A forma de defesa do Red Team é o **ataque**. Esse grupo trabalha simulando ataques cibernéticos reais, com o objetivo de identificar vulnerabilidades e fraquezas nos sistemas de uma organização. Ou seja, essa equipe realiza ataques para identificar pontos fracos antes que ameaças reais os encontrem e os explorem.

Além de simular os ataques cibernéticos, eles realizam testes de penetração (Pen Testing), utilizam técnicas de engenharia social para tentar manipular pessoas e obter acesso às informações — não necessariamente por meio de invasão, mas sim utilizando persuasão — e avaliam a resposta da equipe defensiva às simulações.
...
SOUZA, Cristian. Blue Team e Red Team: Entenda o que são e sua importância para a Cibersegurança. *Alura*, 19 maio 2022. Disponível em: <https://www.alura.com.br/artigos/blue-team-e-red-team-o-que-sao-e-sua-importancia-para-a-ciberseguranca>. Acesso em: 7 fev. 2025.
