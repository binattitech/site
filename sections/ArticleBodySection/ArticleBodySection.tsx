...
import styles from "./ArticleBodySection.module.css";
...
const DEFAULT_SECTIONS: ArticleSection[] = [
  {
    heading: "Definição básica de cibersegurança",
    paragraphs: [
  ...
  {
    heading: "Desenvolvimento seguro",
    paragraphs: [
  ...
  {
    heading: "Importância da cibersegurança",
    paragraphs: [
        ...
        <div className={styles.textColumn}>
          ...
          {sections.map((sec, i) => (
            <div key={i} className={styles.articleSection}>
              <p className={styles.sectionHeading}>{sec.heading}</p>
              <div className={styles.textContainer}>
                {sec.paragraphs.map((text, j) => (
                  <p key={j} className={styles.paragraph}>{text}</p>
                ))}
              </div>
            </div>
          ))}
